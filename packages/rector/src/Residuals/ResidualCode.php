...
final class ResidualCode
{
     ...
     */
    public const string CLASS_UNSAFE_HIERARCHY = 'CLASS_UNSAFE_HIERARCHY';
     ...
     */
    public const string LIFECYCLE_UNSUPPORTED = 'LIFECYCLE_UNSUPPORTED';
     ...
     */
    public const string DATABASE_UNSUPPORTED_CONFIGURATION = 'DATABASE_UNSUPPORTED_CONFIGURATION';
     ...
     */
    public const string HTTP_UNSUPPORTED_SIGNATURE = 'HTTP_UNSUPPORTED_SIGNATURE';

    /**
     * A TestResponse API used by the class has no automatic Laratesto equivalent.
     */
    public const string RESPONSE_UNSUPPORTED_API = 'RESPONSE_UNSUPPORTED_API';

    /**
     * Interactive or chained Artisan testing calls cannot be reproduced safely.
     */
    public const string ARTISAN_INTERACTION_UNSUPPORTED = 'ARTISAN_INTERACTION_UNSUPPORTED';

    /**
     * Laravel test doubles (Mail::fake(), Queue::fake(), ...) have no automatic
     * Laratesto equivalent and must be migrated by hand.
     */
    public const string LARAVEL_FAKE_UNSUPPORTED = 'LARAVEL_FAKE_UNSUPPORTED';
     ...
     */
    public const string LARAVEL_CONSTRUCT_OUTSIDE_HIERARCHY = 'LARAVEL_CONSTRUCT_OUTSIDE_HIERARCHY';
